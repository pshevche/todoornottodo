...
public class MainActivity extends AppCompatActivity implements AdapterCallback {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_add_task:
                ...
                final EditText taskEditText = dialog.findViewById(R.id.add_task_edit_text);
                final CheckBox importantTaskCheckbox = dialog.findViewById(R.id.add_important_task_checkbox);
                final DatePicker deadlineDatepicker = dialog.findViewById(R.id.add_task_deadline);

                final Button addTaskButton = dialog.findViewById(R.id.add_task_button);
                ...
                final Button closeDialogButton = dialog.findViewById(R.id.close_add_dialog_button);
                closeDialogButton.setOnClickListener((v) -> dialog.cancel());
    ...
    public void editTask(Task currentTask) {
        ...
        final EditText taskEditText = dialog.findViewById(R.id.edit_task_edit_text);
        taskEditText.setText(currentTask.getTitle());
        final CheckBox importantTaskCheckbox = dialog.findViewById(R.id.edit_important_task_checkbox);
        importantTaskCheckbox.setChecked(currentTask.isImportant());
        final DatePicker deadlineDatepicker = dialog.findViewById(R.id.edit_task_deadline);
        ...
        final Button addTaskButton = dialog.findViewById(R.id.save_task_button);
        addTaskButton.setOnClickListener((v) -> {
            String task = String.valueOf(taskEditText.getText());
            boolean important = importantTaskCheckbox.isChecked();
            calendar.set(deadlineDatepicker.getYear(), deadlineDatepicker.getMonth(), deadlineDatepicker.getDayOfMonth());
        ...
        final Button closeDialogButton = dialog.findViewById(R.id.close_edit_dialog_button);
        closeDialogButton.setOnClickListener((v) -> dialog.cancel());
